...
RUN apt-get update && apt-get install -y libasound2 libatk1.0-0 libcairo2 libcups2 libdatrie1 libdbus-1-3 libfontconfig1 libfreetype6 libgconf-2-4 \
 ...
 libpango-1.0-0 libpangocairo-1.0-0 libxcomposite1 libxcursor1 libxdmcp6 libxi6 libxrandr2 libxrender1 libxtst6 liblzma5 libxss1 libcurl4-openssl-dev libssl-dev --no-install-recommends \
